document.addEventListener('DOMContentLoaded', () => {
    ...
    function moveOutcomes() {
        ...
        const tail = currentSnake.pop() //removes the last item in the array
    ...
    //generate random apple once apple is eaten 
    ...
    function control(e) {
        ...
        if(e.keyCode === 39) {
            ...
            direction = -width // if we press up arrow, the snake will go back 10 divs, appearing to go up
        } else if (e.keyCode === 37) {
            direction = -1 // if we press the left arrow, the snake will go left
        } else if (e.keyCode === 40) {
            direction = +width // if we press down arrow, the snake will instantly appear in the div ten divs from where you are
        }
    }
